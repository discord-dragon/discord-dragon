declare module "discord-handler" {
  import {
    BufferResolvable,
    Client,
    ClientOptions,
  ...
  export class DragonClient extends Client {
    public constructor(
      options?: DragonOptions & ClientOptions,
  ...
  export class DragonHandler extends EventEmitter {
    public constructor(client: DragonClient, options: DragonHandlerOptions);

    public automateCategories: boolean;
    public extensions: Set<string>;
    public categories: Collection<string, Category<string, DragonModule>>;
    public classToHandle: Function;
    public client: DragonClient;
    public directory: string;
    public loadFiler: LoadPredicate;
    public modules: Collection<string, DragonModule>;

    public deregister(mod: DragonModule): void;
    public findCategory(name: string): Category<string, DragonModule>;
    public load(thing: string | Function, isReload?: boolean): DragonModule;
    public loadAll(directory?: string, filter?: LoadPredicate): this;
    public register(mod: DragonModule, filepath?: string): void;
    public reload(id: string): DragonModule;
    public reloadAll(): this;
    public remove(id: string): DragonModule;
    public removeAll(): this;
    public on(event: "remove", listener: (mod: DragonModule) => any): this;
    public on(
      event: "load",
      listener: (mod: DragonModule, isReload: boolean) => any
    ): this;
  ...
  export class DragonModule {
    public constructor(id: string, options?: DragonModuleOptions);

    public category: Category<string, DragonModule>;
    public categoryID: string;
    public client: DragonClient;
    public filepath: string;
    public handler: DragonHandler;
    public id: string;
  ...
  export class Argument {
    ...
    public readonly client: DragonClient;
  ...
  export class ClientUtil {
    public constructor(client: DragonClient);
  ...
  export class Command extends DragonModule {
  ...
  export class CommandHandler extends DragonHandler {
    public constructor(client: DragonClient, options: CommandHandlerOptions);
  ...
  export class Inhibitor extends DragonModule {
  ...
  export class InhibitorHandler extends DragonHandler {
    public constructor(client: DragonClient, options: DragonHandlerOptions);
  ...
  export class Listener extends DragonModule {
  ...
  export class ListenerHandler extends DragonHandler {
    public constructor(client: DragonClient, options: DragonHandlerOptions);
  ...
  export interface DragonHandlerOptions {
  ...
  export interface DragonModuleOptions {
    category?: string;
  }
  ...
  export interface CommandOptions extends DragonModuleOptions {
    aliases?: string[];
  ...
  export interface CommandHandlerOptions extends DragonHandlerOptions {
  ...
  export interface InhibitorOptions extends DragonModuleOptions {
    reason?: string;
    type?: string;
    priority?: number;
  }

  export interface ListenerOptions extends DragonModuleOptions {
